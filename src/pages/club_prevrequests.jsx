...
import ClubPrevRequestsCard from "../components/clubPrevRequestsCard";
import ClubPrevRequestsHeader from "../components/clubPrevRequestsHeader";
const data = [
  {
...
const page = () => {
  return (
    <>
      {" "}
      <ClubPrevRequestsHeader clubName="System Coding Club" picName="Priyanka Kokil" />{" "}
      <div className="px-4 pt-4 pb-12 sm:px-6 md:px-8">
        ...
        <ul className="mt-4 space-y-4">
          {data.map((item, index) => (
            <ClubPrevRequestsCard key={index} {...item} />
          ))}
        </ul>
      </div>
    </>
