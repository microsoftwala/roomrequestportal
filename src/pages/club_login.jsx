...
import ClubLoginHeader from "../components/clubLoginHeader";
import ClubLoginFooter from "../components/clubLoginFooter";
...
export default function ClubLogin(){
    ...
    const Postdata = async (e)=>
    {
        ...
        const link = 'https://api.sheety.co/5d30ad2c5b720283d5479987e6348e9d/cLubLogin/sheet1'
        const params = {
          sheet1: login
        }
    ...
    return(
        ...
        <Box sx={{ mt:"5%",width:{xs:"75%",sm:"60%",md:"50%"},justifyContent:"center",background:"#D9D9D9",ml:"auto",mr:"auto",pb:"2%",mb:"5%"}}>
            ...
            <form onSubmit={Postdata}>
                ...
                <br />
                <input type="text" required className="bg-transparent hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 border border-black hover:border-transparent rounded-none ml-5 w-5/6" name="email" onChange={Handlelogininput}/>
                <br />
