...
const Card = ({ nameOfTheEvent, date, hallBooked, request, status }) => {
  return (
    <li  style={{ backgroundColor: "#80808080;" }} className="flex flex-col py-4 rounded-md shadow-md bg-club_prevrequests-card-bg text-club_prevrequests-card-text sm:flex-row">
